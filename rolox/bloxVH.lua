...
Main:AddButton("Xóa âm thanh",function()
...
Main:AddToggle("Xóa hiệu ứng đánh",false,function(value)
getgenv().D = value
end)

Main:AddButton("xóa hiệu ứng dame", function()
game:GetService("ReplicatedStorage").Assets.GUI.DamageCounter.Enabled = false
end)

fast:AddSeperator("cài đặt tấn công")

fast:AddToggle("Tấn công nhanh",true,function(Fast)
...
fast:AddToggle("Tấn công nhanh 1",false,function(Fastz)
...
fast:AddToggle("Tấn công nhanh 2",false,function(Fastx)
...
fast:AddToggle("Tấn công nhanh 3",false,function(Fastc)
...
CameraShakerR:Stop()
CombatFramework.activeController.attacking = false
CombatFramework.activeController.timeToNextAttack = 50
...
fast:AddToggle("Tấn công nhanh  4",false,function(Fastd)
...
Main:AddToggle("Auto cài đặt điểm Spawn",true,function(value)
...
Main:AddToggle("Dồn quái",true,function(value)
...
Main:AddButton("làm mới danh sách",function()
SelectWeapona:Clear()
for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
...
if World1 then
auto:AddToggle("Auto đến sea 2",_G.AutoSecondSea,function(value)
...
if World2 then
auto:AddToggle("Auto đến sea 3",_G.AutoThirdSea,function(value)
...
if World2 then
auto:AddToggle("Auto đánh nhà máy",_G.AutoFactory,function(value)
...
elseif World3 then
auto:AddToggle("Auto đảo bí ẩn",_G.AutoMysticIsland,function(value)
...
Main:AddSeperator("Auto đấm tay")
...
Main:AddSeperator("Thuần thục")

Main:AddToggle("Auto Thuần thục trái ác quỷ",_G.AutoFarmFruitMastery,function(value)
...
Main:AddToggle("Auto Farm Thuần thục súng",_G.AutoFarmGunMastery,function(value)
...
_G.Kill_At = 25
Main:AddSlider("giết khi HP còn %",1,100,25,function(value)
_G.Kill_At = value
end)
...
Main:AddButton("làm mới danh sách boss",function()
BossName:Clear()
for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
if string.find(v.Name, "Boss") then
BossName:Add(v.Name)
...
Main:AddToggle("Auto đánh Boss",_G.AutoFarmBoss,function(value)
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
...
Main:AddToggle("Auto đánh tất cả Boss",_G.AutoAllBoss,function(value)
_G.AutoAllBoss = value
StopTween(_G.AutoAllBoss)
end)

Main:AddToggle("Auto đánh tất cả Boss Hop",_G.AutoAllBossHop,function(value)
...
Main:AddSeperator("Hầm ngục nâng cao")

Main:AddToggle("Auto Hầm ngục nâng cao",_G.AutoAdvanceDungeon,function(value)
...
Main:AddSeperator("lưỡi hái linh hồn")
...
local BoneFarm = Main:AddToggle("Auto cày xương",_G.Auto_Bone,function(value)
_G.Auto_Bone = value
...
Main:AddToggle("Auto Farm haki quan sát",_G.AutoObservation,function(value)
...
Main:AddToggle("Auto Farm haki quan sat Hop",_G.AutoObservation_Hop,function(value)
...
Main:AddSeperator("Kiếm huyền thoại")

Main:AddToggle("Auto Kiếm huyền Thoại",_G.AutoBuyLegendarySword,function(value)
...
Main:AddSeperator("Tăng cường màu sắc")

Main:AddToggle("Auto Tăng cường màu sắc",_G.AutoBuyEnchancementColour,function(value)
_G.AutoBuyEnchancementColour = value
end)

Main:AddToggle("Auto Tăng cường màu sắc Hop",_G.AutoBuyEnchancementColour_Hop,function(value)
...
Main:AddToggle("Auto mũ lính ngự lâm",_G.AutoMusketeerHat,function(value)
...
Main:AddToggle("Auto quan sát Haki v2",_G.AutoObservationv2,function(value)
...
Main:AddToggle("Auto Farm tinh chất",_G.AutoEctoplasm,function(value)
...
Main:AddToggle("Auto nhiệm vụ Bartlio",_G.AutoBartilo,function(value)
...
Main:AddToggle("Auto ngọn đuốc thánh",_G.AutoHolyTorch,function(value)
...
local SelectedPly = Combat:AddDropdown("Chọn người chơi",Playerslist,function(value)
_G.SelectPly = value
end)

Combat:AddButton("làm mới ds người chơi",function()
Playerslist = {}
SelectedPly:Clear()
for i,v in pairs(game:GetService("Players"):GetChildren()) do
...
Combat:AddToggle("xem người chơi",false,function(value)
SpectatePlys = value
...
Combat:AddToggle("Di chuyển",false,function(value)
...
Combat:AddToggle("Auto đánh người chơi",false,function(value)
...
Combat:AddSeperator("ngắm chuẩn")
...
Combat:AddToggle("bật PvP",false,function(value)
_G.EnabledPvP = value
end)
...
Stats:AddSeperator("Auto cộng điểm")

local Pointstat = Stats:AddLabel("Stat cộng điểm")

spawn(function()
while wait() do
pcall(function()
Pointstat:Set("Stat cộng điểm : "..tostring(game:GetService("Players")["LocalPlayer"].Data.Points.Value))
end)
end
end)

Stats:AddToggle("Auto cận chiến",_G.Auto_Melee,function(value)
_G.Auto_Melee = value
end)

Stats:AddToggle("Auto phòng thủ",_G.Auto_Defense,function(value)
_G.Auto_Defense = value
end)

Stats:AddToggle("Auto kiếm",_G.Auto_Sword,function(value)
_G.Auto_Sword = value
end)

Stats:AddToggle("Auto súng",_G.Auto_Gun,function(value)
_G.Auto_Gun = value
end)

Stats:AddToggle("Auto trái ác quỷ",_G.Auto_DevilFruit,function(value)
_G.Auto_DevilFruit = value
end)

_G.PointStats = 1
Stats:AddSlider("số điểm cộng",1,1000,1,function(value)
_G.PointStats = value
end)
...
Teleport:AddButton("di chuyển đến biển 2",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
end)

Teleport:AddButton("di chuyển đến biển 3",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
end)

Teleport:AddButton("di chuyển đến thủy quái ",function()
...
Teleport:AddSeperator("đảo")

if World1 then
Teleport:AddDropdown("chọn đảo",{
"Đảo hành hải",
"Đảo trung tâm",
"Rừng",
"Làng hải tặc",
...
Teleport:AddToggle("Dịch chuyển",false,function(value)
...
Dungeon:AddToggle("Auto đánh hạng",_G.Auto_Dungeon,function(value)
...
Dungeon:AddToggle("Auto thức tỉnh",_G.Auto_Awakener,function(value)
...
Dungeon:AddDropdown("chọn chip",{"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha","Sand","Bird: Phoenix"},function(value)
_G.SelectChip = value
end)

Dungeon:AddToggle("Auto chọn Dungeon",_G.AutoSelectDungeon,function(value)
...
DevilFruit:AddToggle("Auto ngẫu nhiên trái",_G.Random_Auto,function(value)
...
DevilFruit:AddToggle("Auto vứt trái ác quỷ",_G.DropFruit,function(value)
_G.DropFruit = value
end)
...
DevilFruit:AddToggle("Của hành trái",_G.AutoStoreFruit,function(value)
...
Shop:AddSeperator("Phong cách chiến đấu")
...
Misc:AddButton("Mở shop trái cây",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
...
Misc:AddButton("mở kho trái cây",function()
...
Misc:AddButton("nhận tất cả quà",function()
...
Misc:AddDropdown("chọn quà",{"1MLIKES_RESET","THIRDSEA","SUB2GAMERROBOT_RESET1","SUB2UNCLEKIZARU"},function(value)
_G.CodeSelect = value
end)

Misc:AddButton("nhận quà",function()
game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(_G.CodeSelect)
end)

Misc:AddSeperator("State")

Misc:AddDropdown("chọn tầng haki",{"State 0","State 1","State 2","State 3","State 4","State 5"},function(value)
